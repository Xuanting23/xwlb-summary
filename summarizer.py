...
1. **top_news**: 挑选 3-5 条最重要的国内要闻。importance 为 1-5 星。
2. **domestic_briefs**: 国内联播快讯，每条 1-2 句话，通常 3-8 条。每条都要写。
3. **international_news**: 国际新闻详细摘要。请仔细阅读原文，把每一条国际新闻都单独列出，不要遗漏。
